...
export const dictionaries = {
  es: {
    ...
    dashboard: {
      ...
      welcomeTitle: "Bienvenida/o a Terra Araras",
      welcomeText: "Ara te está esperando para guiarte. Tocá su ícono abajo a la derecha.",
    },
    intake: {
      title: "¡Hola, soy Ara!",
      subtitle: "¿Cómo querés que trabajemos hoy?",
  ...
  pt: {
    ...
    dashboard: {
      ...
      welcomeTitle: "Bem-vindo(a) à Terra Araras",
      welcomeText: "A Ara está esperando para te guiar. Toque no ícone dela no canto inferior direito.",
    },
    intake: {
      title: "Olá, eu sou a Ara!",
      subtitle: "Como você quer que trabalhemos hoje?",
